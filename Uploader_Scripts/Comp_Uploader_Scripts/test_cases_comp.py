"""test_cases_comp.py — Compare-and-update uploader for 'test_cases' by test_case_id."""
import os, sys
...
MONGO_URI="mongodb://localhost:27017/"; DB_NAME="test_db"; COLLECTION="test_cases"; UNIQUE_FIELD="test_case_id"
EXCEL_FILE=os.path.join(os.path.dirname(__file__),"..","..","input_folder","test_cases_data.xlsx")
SHEET_NAME="TestCases"; HEADER_ROW=1
