"""projects_comp.py — Compare-and-update uploader for 'projects' by project_id."""
import os, sys
...
MONGO_URI="mongodb://localhost:27017/"; DB_NAME="test_db"; COLLECTION="projects"; UNIQUE_FIELD="project_id"
EXCEL_FILE=os.path.join(os.path.dirname(__file__),"..","..","input_folder","projects_data.xlsx")
SHEET_NAME="Projects"; HEADER_ROW=1
