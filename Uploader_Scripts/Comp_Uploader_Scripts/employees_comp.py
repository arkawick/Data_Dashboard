"""
employees_comp.py  —  Compare-and-update uploader for 'employees'.
Compares incoming Excel rows against MongoDB by employee_id:
  - New record    → insert  with db_status='added'
  - Existing      → update  with db_status='updated'
  - No longer in Excel → db_status='deleted'
